    ...
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="sidebar-sticky p-4">
                <h5 class="sidebar-heading justify-content-center align-items-center">Seguindo</h5>
                <ul class="nav flex-column justify-content-center align-items-center">
                    @foreach($usersFollowing as $userFollowed)
                        <li class="nav-item">
                            <a href="{{ route('user.profile', ['user' => $userFollowed->userFollowed()->first()->id]) }}">
                                {{ $userFollowed->userFollowed()->first()->name }}
                            </a>
                        </li>
                    @endforeach
                </ul>
